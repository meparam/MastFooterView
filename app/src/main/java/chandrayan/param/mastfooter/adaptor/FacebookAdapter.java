package chandrayan.param.mastfooter.adaptor;
    ...
    private void setUpUserImage(ImageView iv, FacebookPost post) {
        ...
        if (!TextUtils.isEmpty(avatarUrl)) {
            Picasso.with(context)
                    .load(avatarUrl)
                    .centerCrop()
                    .resize(AppUtils.dp2px(context, 34),
                            AppUtils.dp2px(context, 34))
...
//                    .placeholder(R.drawable.ic_facebook)
                    .centerCrop()
                    .resize(AppUtils.dp2px(context, 346),
                            AppUtils.dp2px(context, 320))
                    .error(android.R.drawable.stat_notify_error)
                    .into(iv);
        }
    }
