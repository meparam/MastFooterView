package chandrayan.param.mastfooter.recycleScroll;
...
/**
 * Created by param on 29/09/17.
 */
public class RecyclerViewOnScrollListener extends RecyclerView.OnScrollListener {

    // region Member Variables
    private final ViewType mQuickReturnViewType;
    ...
    // region Constructors
    private RecyclerViewOnScrollListener(Builder builder) {
    ...
    public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
        ...
        int scrollY = AppUtils.getScrollY(recyclerView, mColumnCount);
...
//        Log.d("", "onScrolled() : diff - "+diff);
    ...
    public static class Builder {
        ...
        public Builder(ViewType quickReturnViewType) {
        ...
        public RecyclerViewOnScrollListener build() {
            return new RecyclerViewOnScrollListener(this);
        }
    }
