package chandrayan.param.mastfooter.utils;
...
//        if(scrollY>0)
//            Log.d("AppUtils", "getScrollY() : -(c.getTop()) - "+ -(c.getTop()));
//        else
//            Log.i("AppUtils", "getScrollY() : -(c.getTop()) - "+ -(c.getTop()));

        if (scrollY < 0)
            scrollY = 0;

        for (int i = 0; i < firstVisiblePosition; ++i) {
//            Log.d("AppUtils", "getScrollY() : i - "+i);

//            Log.d("AppUtils", "getScrollY() : sListViewItemHeights.get(i) - "+sListViewItemHeights.get(i));
...
//        Log.d("AppUtils", "getScrollY() : scrollY - "+scrollY);
...
//        Log.d("", "getScrollY() : scrollY - " + scrollY);
        ...
        if (columnCount > 1) {
            sRecyclerViewItemHeights.put(firstVisiblePosition, c.getHeight() + AppUtils.dp2px(rv.getContext(), 8) / columnCount);
        } else {
